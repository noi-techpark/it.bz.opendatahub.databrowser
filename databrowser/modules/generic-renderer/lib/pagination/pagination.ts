...
export interface PaginationUrlBuilder {
  getUrlForCurrentPage: () => string;
  getUrlForNextPage: () => string;
  getUrlForPreviousPage: () => string;
}

export const defaultPaginationUrlBuilder = {
  getUrlForCurrentPage: () => '',
  getUrlForNextPage: () => '',
  getUrlForPreviousPage: () => '',
};

export abstract class PaginationProvider {
  pagination: BasePagination;

  constructor(pagination: BasePagination) {
...
// export interface WithMobilityPagination {
//   offset: number;
//   limit: number;
//   data: any[];
// }
