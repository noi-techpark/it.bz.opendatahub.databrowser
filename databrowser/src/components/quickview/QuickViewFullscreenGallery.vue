<template>
  <div class="relative flex items-center overflow-x-hidden md:gap-2">
    ...
    <div
      ...
      class="absolute top-1/2 left-2 right-auto flex h-9 w-9 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full border border-gray-250 bg-white hover:bg-green-400 hover:bg-opacity-90 hover:text-white"
      @click="prevImage()"
    >
