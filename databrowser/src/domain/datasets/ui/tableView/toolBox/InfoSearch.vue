  ...
  <InfoPopover>
    <PopoverCustomPanel>
      <PopoverContentHeader class="pb-0">
        {{
          t(
            'datasets.listView.toolBox.searchAndFilter.basicSearch.infoPopup.header'
          )
        }}
      ...
      <PopoverContent class="flex max-w-sm flex-col gap-3 pt-2">
        {{
          t(
            'datasets.listView.toolBox.searchAndFilter.basicSearch.infoPopup.body'
          )
        }}
        <ButtonExternalLink
          ...
          :href="
            t(
              'datasets.listView.toolBox.searchAndFilter.basicSearch.infoPopup.linkHref'
            )
          "
          :size="Size.xs"
        ...
        >
          {{
            t(
              'datasets.listView.toolBox.searchAndFilter.basicSearch.infoPopup.linkText'
            )
          }}
        </ButtonExternalLink>
      </PopoverContent>
