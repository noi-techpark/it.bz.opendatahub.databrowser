...
// This regex is used to parse the rawfilter parameter from the Tourism API URL.
//
...
// - likein(propertyPath, value)
//
// Where:
// - operator is one of the above: eq, ne, gt, lt, ge, le, isnull, isnotnull, in, nin, like, likein
//
